...
public class ViewChiTietSanPham extends javax.swing.JPanel {
    ...
    public ViewChiTietSanPham() {
        ...
        loadCombox(ldhImpl.getAllRespone());
        loadTable(listCTSP);
    }

    private void loadCombox(List<LoaiDongHoResponse> list) {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        LoaiDongHo ldh = (LoaiDongHo) model.getElementAt(cbxLoaiDongHo.getSelectedIndex());
