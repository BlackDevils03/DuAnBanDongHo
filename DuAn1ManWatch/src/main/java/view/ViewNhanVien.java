...
public class ViewNhanVien extends javax.swing.JPanel {
    ...
    private NhanVienService nvImpl = new NhanVienServiceImpl();
    private List<NhanVienResponse> list = new ArrayList<>();

    public ViewNhanVien() {
        initComponents();
        list = nvImpl.getAllResponse();
        loadTable(list);
    }

    private void loadTable(List<NhanVienResponse> list) {
        DefaultTableModel dtm = new DefaultTableModel();
        dtm.setColumnIdentifiers(new String[]{"STT", "Ma", "Họ Và Tên", "Giới Tính", "Ngày Sinh", "Chức Vụ", "Địa Chỉ"});
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        nv.setNgaySinh(datePicker1.getText());
        ...
        String check = nvImpl.insert(nv);
        JOptionPane.showMessageDialog(this, check);
        loadTable(nvImpl.getAllResponse());
